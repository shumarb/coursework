...
double deviation(double [], int size);
double average(double [], int size);
double sum_of_difference(double [], int size);
...
{
	return sqrt(sum_of_difference(val, size) / (double) size);
}
