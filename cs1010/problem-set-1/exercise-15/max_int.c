...
int main(void) {
	...
	//Pass the integers to get_max function for comparison
...
int get_max(int num1, int num2, int num3) {
	if((num1>num2) && (num1>num3)){
		return num1;//Return num1 if it is the largest integer among the integers
	}
	else if((num2>num1) && (num2>num3)){
		return num2;//Return num2 if it is the largest integer among the integers
	}
	else{
		return num3;//num3 is the largest integer if the above 2 if-else conditions are not satisfied
	}
}
